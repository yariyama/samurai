...
public class CameraManager : MonoBehaviour
{
    ...
    //方向オブジェクト★
    private GameObject _Dire;
    //方向スクリプト★
    private DireManager _DireManager;
    ...
    void Awake()
    {
        ...
        //★
        _Dire = GameObject.Find("Dire");
        _DireManager = _Dire.GetComponent<DireManager>();
    ...
    public void PosSet()
    {
        if (_tp2 == 1)
        {
            _position.x = _Boy.transform.position.x;
            _position.z = _Boy.transform.position.z - 10;
        }
        else if (_tp2 == 2)
        {

            _position.x = _Boy.transform.position.x + 10;
            _position.z = _Boy.transform.position.z;
        }
        else if (_tp2 == 3)
        {
            _position.x = _Boy.transform.position.x;
